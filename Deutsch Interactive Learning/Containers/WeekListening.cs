...
{
    class WeekListening : ViewControls.ContainerControls.Container
    {
        ...
        public WeekListening(Form ParentForm, FlatDesign.Colors Colors)
        {
            this.Colors = Colors;
        ...
        private void GermanDayLabel_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            Thread thread = new Thread(() => { speechSynthesizer.Speak(GermanDays[Position]); });
