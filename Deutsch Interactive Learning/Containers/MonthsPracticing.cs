...
{
    class MonthsPracticing : ViewControls.ContainerControls.Container
    {
        ...
        public MonthsPracticing(Form ParentForm, FlatDesign.Colors Colors)
        {
            this.Colors = Colors;
        ...
        private void GermanMonthLabel_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            speechSynthesizer.Speak(GermanMonths[Position]);
            SetMonthToRecognize();
        }
        ...
        private void SpeechRecognitionEngine_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            if (e.Result.Confidence * 100 >= 90)
                GermanMonthLabel.ForeColor = Color.Gold;
        }
