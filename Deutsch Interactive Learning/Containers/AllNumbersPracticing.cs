...
{
    class AllNumbersPracticing : ViewControls.ContainerControls.Container
    {
        ...
        private void NumberWordLabel_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            speechSynthesizer.Speak(NumberWordLabel.Text);
            SetNumberWordToRecognize(NumberWordLabel.Text);
        }
        ...
        private void NumberWordPartsLabel_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            speechSynthesizer.Speak(NumberWordPartsToSpeak);
            SetNumberWordPartsToRecognize(NumberWordPartsToSpeak);
        }
        ...
        private void SetNumberWordToRecognize(string NumberWord)
        {
            speechRecognitionEngine = new SpeechRecognitionEngine(cultureInfo);
            speechRecognitionEngine.SetInputToDefaultAudioDevice();
            speechRecognitionEngine.SpeechRecognized += SetNumberWordToRecognize_SpeechRecognized;
            GrammarBuilder grammarBuilder = new GrammarBuilder();
            grammarBuilder.Culture = cultureInfo;
            grammarBuilder.Append(NumberWord);
            Grammar grammar = new Grammar(grammarBuilder);
            speechRecognitionEngine.LoadGrammar(grammar);
            speechRecognitionEngine.RecognizeAsync(RecognizeMode.Multiple);
        }

        private void SetNumberWordToRecognize_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
        ...
        private void SetNumberWordPartsToRecognize(string NumberWordParts)
        {
            speechRecognitionEngine = new SpeechRecognitionEngine(cultureInfo);
            speechRecognitionEngine.SetInputToDefaultAudioDevice();
            speechRecognitionEngine.SpeechRecognized += SetNumberWordPartsToRecognize_SpeechRecognized;
            Choices NumberWordPartsToRecognise = new Choices();
            NumberWordPartsToRecognise.Add(NumberWordParts);
            GrammarBuilder grammarBuilder = new GrammarBuilder();
            grammarBuilder.Culture = cultureInfo;
            grammarBuilder.Append(NumberWordPartsToRecognise);
            Grammar grammar = new Grammar(grammarBuilder);
            speechRecognitionEngine.LoadGrammar(grammar);
            speechRecognitionEngine.RecognizeAsync(RecognizeMode.Multiple);
        }

        private void SetNumberWordPartsToRecognize_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            if (e.Result.Confidence * 100 >= 80)
                NumberWordPartsLabel.ForeColor = Color.Gold;
        }
